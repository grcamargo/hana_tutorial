...
function getMemStats() {
    ...
    let mem = '';
    mem += "rss: " + used.rss.toLocaleString() + " ";
    mem += "heapTotal: " + used.heapTotal.toLocaleString() + " ";
    mem += "heapUsed: " + used.heapUsed.toLocaleString() + " ";
    if (used.external) {
        mem += "external: " + used.external.toLocaleString();
    }
    return mem;
}
...
Logger.prototype.logSqlParameters = function (parameters, force) {

    if ( XSODATA_LOG_SQL_COMMAND >= 2 && (XSODATA_LOG_SQL_PARAMETERS >= 2 || force)) {
